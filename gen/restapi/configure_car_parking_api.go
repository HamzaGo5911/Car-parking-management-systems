...
//go:generate swagger generate server --target ../../gen --name CarParkingAPI --spec ../../swagger.yaml --principal interface{}

func configureFlags(api *operations.CarParkingAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CarParkingAPIAPI) http.Handler {
